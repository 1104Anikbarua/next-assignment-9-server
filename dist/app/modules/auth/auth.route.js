...
router.post("/change-password", (0, auth_middleware_1.auth)(), (0, validateRequest_middleware_1.validateRequest)(auth_validation_1.authValidations.changePassword), auth_controller_1.authControllers.changePassword);
// create admin routes
